...
QtObject {
    ...
    readonly property var gadgets: [
        ...
        { id: "cpu",          name: i18n("CPU Meter"),       icon: Qt.resolvedUrl("icons/cpu-symbolic.svg"), iconFallback: "cpu", category: "system",
        ...
        { id: "gpu",          name: i18n("GPU Meter"),       icon: Qt.resolvedUrl("icons/gpu-symbolic.svg"), iconFallback: "cpu", category: "system",
        ...
        { id: "sensors",      name: i18nc("@title gadget showing hardware temperatures", "Sensor"), icon: Qt.resolvedUrl("icons/temperature-symbolic.svg"), iconFallback: "temperature-normal", category: "system",
        ...
        { id: "fans",         name: i18n("Fans"),            icon: Qt.resolvedUrl("icons/fan-symbolic.svg"), iconFallback: "computer-symbolic", category: "system",
          description: i18n("Speed of every fan the system reports"),
          sizes: ["1x1", "2x1", "1x2", "2x2"], defaultSize: "1x1", source: "FansGadget.qml", online: false, multiple: false },
